...
export const SalesRevenueByRegion = ({ data }: { data: SalesAnalyticsData | null }) => {
    return (
        <div className="grow flex flex-col gap-5 justify-between  p-4 rounded-md border border-[#C9C9C9] dark:border-gray-700 dark:bg-gray-800">
            {/* Pie Chart Section */}
            ...
            <div className=" text-[#1A0670] dark:text-white">
